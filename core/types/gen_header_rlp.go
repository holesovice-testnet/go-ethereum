...
func (obj *Header) DecodeRLP(dec *rlp.Stream) error {
	var _tmp0 Header
	{
		...
		if dec.MoreDataInList() {
			...
			// VerkleProof:
			if dec.MoreDataInList() {
				_tmp17, err := dec.Bytes()
				if err != nil {
					return err
				}
				_tmp0.VerkleProof = _tmp17
				// VerkleKeyVals:
				if dec.MoreDataInList() {
					var _tmp18 []verkle.KeyValuePair
					if _, err := dec.List(); err != nil {
						return err
					}
					for dec.MoreDataInList() {
						var _tmp19 verkle.KeyValuePair
						{
							if _, err := dec.List(); err != nil {
								return err
							}
							// Key:
							_tmp20, err := dec.Bytes()
							if err != nil {
								return err
							}
							_tmp19.Key = _tmp20
							// Value:
							_tmp21, err := dec.Bytes()
							if err != nil {
								return err
							}
							_tmp19.Value = _tmp21
						...
						_tmp18 = append(_tmp18, _tmp19)
					}
					if err := dec.ListEnd(); err != nil {
						return err
					}
					_tmp0.VerkleKeyVals = _tmp18
				}
			}
		}
		if err := dec.ListEnd(); err != nil {
